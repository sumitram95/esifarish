        ...
        <div class="col-md-6">
            <div class="myLeftCtn login-right" style="">
                <div class="text-center">
                    <header> रिसेट - पासवर्ड </header>

                    <form method="POST" action="https://esifarish.tilottamamun.gov.np/forget-password"
                        accept-charset="UTF-8" data-parsley-validate class="myForm" autocomplete="off">
                        <input name="_token" type="hidden" value="hKPXFA51kJm7gN7LLiOIdISlMQQpRqnUsBatPwR6">
                        <div class="form-group">
                            <i class="fas fa-user"></i>
                            <input class="myInput eng_s राख्नुहोस" id="username"
                                data-parsley-required-message="Email अनिवार्य छ ।" required>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <button type="submit" class="buttonsubmit ml-4"> नयाँ पासवर्ड अनुरोध
                            गर्नुहोस्</button><br>
